...
namespace LangExt2
{
    ...
    public static partial class Seq
    {
        ...
        {
            return LangExt2.Create.Tuple(new Seq<T>(self).Take(n), new Seq<T>(self).Skip(n));
        }
        ...
        {
            return LangExt2.Create.Tuple(new Seq<T>(self).TakeWhile(pred), new Seq<T>(self).SkipWhile(pred));
        }
        ...
        {
            return LangExt2.Create.Tuple(new Seq<T>(self).TakeWhile(t => !pred(t)), new Seq<T>(self).SkipWhile(t => !pred(t)));
        }
        #endregion
