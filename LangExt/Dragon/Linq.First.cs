...
namespace LangExt.Dragon
{
    ...
    {
        /// <summary>
        /// タプルのシーケンスの各要素を展開して predicate に渡す head です。
        /// 見つからなかった場合は例外を送出します。
        /// </summary>
        ...
        /// <param name="self">返される要素が含まれるシーケンス。</param>
        /// <param name="predicate">各要素が条件を満たしているかどうかをテストする関数。</param>
        /// <returns>条件を満たす最初の要素。条件を満たす要素が見つからなかった場合、規定値。</returns>
        public static _<T1, T2> FirstOrDefault<T1, T2>(this IEnumerable<_<T1, T2>> self, Func<T1, T2, bool> predicate)
        {
            return self.FirstOrDefault(t => predicate(t._1, t._2));
        }
        ...
        /// <param name="predicate">各要素が条件を満たしているかどうかをテストする関数。</param>
        /// <returns>条件を満たす最初の要素。条件を満たす要素が見つからなかった場合、規定値。</returns>
        public static _<T1, T2, T3> FirstOrDefault<T1, T2, T3>(this IEnumerable<_<T1, T2, T3>> self, Func<T1, T2, T3, bool> predicate)
        {
            return self.FirstOrDefault(t => predicate(t._1, t._2, t._3));
        }
        ...
        /// <param name="predicate">各要素が条件を満たしているかどうかをテストする関数。</param>
        /// <returns>条件を満たす最初の要素。条件を満たす要素が見つからなかった場合、規定値。</returns>
        public static _<T1, T2, T3, T4> FirstOrDefault<T1, T2, T3, T4>(this IEnumerable<_<T1, T2, T3, T4>> self, Func<T1, T2, T3, T4, bool> predicate)
        {
            return self.FirstOrDefault(t => predicate(t._1, t._2, t._3, t._4));
        }
        ...
        /// <param name="predicate">各要素が条件を満たしているかどうかをテストする関数。</param>
        /// <returns>条件を満たす最初の要素。条件を満たす要素が見つからなかった場合、規定値。</returns>
        public static _<T1, T2, T3, T4, T5> FirstOrDefault<T1, T2, T3, T4, T5>(this IEnumerable<_<T1, T2, T3, T4, T5>> self, Func<T1, T2, T3, T4, T5, bool> predicate)
        {
            return self.FirstOrDefault(t => predicate(t._1, t._2, t._3, t._4, t._5));
        }
        ...
        /// <param name="predicate">各要素が条件を満たしているかどうかをテストする関数。</param>
        /// <returns>条件を満たす最初の要素。条件を満たす要素が見つからなかった場合、規定値。</returns>
        public static _<T1, T2, T3, T4, T5, T6> FirstOrDefault<T1, T2, T3, T4, T5, T6>(this IEnumerable<_<T1, T2, T3, T4, T5, T6>> self, Func<T1, T2, T3, T4, T5, T6, bool> predicate)
        {
            return self.FirstOrDefault(t => predicate(t._1, t._2, t._3, t._4, t._5, t._6));
        }
        ...
        /// <param name="predicate">各要素が条件を満たしているかどうかをテストする関数。</param>
        /// <returns>条件を満たす最初の要素。条件を満たす要素が見つからなかった場合、規定値。</returns>
        public static _<T1, T2, T3, T4, T5, T6, T7> FirstOrDefault<T1, T2, T3, T4, T5, T6, T7>(this IEnumerable<_<T1, T2, T3, T4, T5, T6, T7>> self, Func<T1, T2, T3, T4, T5, T6, T7, bool> predicate)
        {
            return self.FirstOrDefault(t => predicate(t._1, t._2, t._3, t._4, t._5, t._6, t._7));
        }
        ...
        /// <param name="predicate">各要素が条件を満たしているかどうかをテストする関数。</param>
        /// <returns>条件を満たす最初の要素。条件を満たす要素が見つからなかった場合、規定値。</returns>
        public static _<T1, T2, T3, T4, T5, T6, T7, T8> FirstOrDefault<T1, T2, T3, T4, T5, T6, T7, T8>(this IEnumerable<_<T1, T2, T3, T4, T5, T6, T7, T8>> self, Func<T1, T2, T3, T4, T5, T6, T7, T8, bool> predicate)
        {
            return self.FirstOrDefault(t => predicate(t._1, t._2, t._3, t._4, t._5, t._6, t._7, t._8));
        }
        ...
        /// <param name="predicate">各要素が条件を満たしているかどうかをテストする関数。</param>
        /// <returns>条件を満たす最初の要素。条件を満たす要素が見つからなかった場合、規定値。</returns>
        public static _<T1, T2, T3, T4, T5, T6, T7, T8, T9> FirstOrDefault<T1, T2, T3, T4, T5, T6, T7, T8, T9>(this IEnumerable<_<T1, T2, T3, T4, T5, T6, T7, T8, T9>> self, Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, bool> predicate)
        {
            return self.FirstOrDefault(t => predicate(t._1, t._2, t._3, t._4, t._5, t._6, t._7, t._8, t._9));
        }
        ...
        /// <param name="predicate">各要素が条件を満たしているかどうかをテストする関数。</param>
        /// <returns>条件を満たす最初の要素。条件を満たす要素が見つからなかった場合、規定値。</returns>
        public static _<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> FirstOrDefault<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(this IEnumerable<_<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> self, Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, bool> predicate)
        {
            return self.FirstOrDefault(t => predicate(t._1, t._2, t._3, t._4, t._5, t._6, t._7, t._8, t._9, t._10));
        }
